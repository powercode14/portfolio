    ...
    <script>
        $(function() {
            ...
            $(".Project .image:eq(0)").on('click', function(){
                open('https://drive.google.com/open?id=0B6hbga8gQ8DTd21JUWpRNUZfRWM');
            });

            $(".Project .image:eq(1)").on('click', function(){
                open('https://drive.google.com/open?id=1FQT16Bg3VVpsN-EzzTaGmO4y_NqZyNb8');
            });
...
<div class="All">
    <div class="Home" id="Home">
        ...
        <div class="About" id="About">
            <div class="desc hide">
                ...
                <section class="desc-right">
                    <p>저는 어릴 때부터 컴퓨터를 잘 다뤄서<br>
                       성인이 되면 컴퓨터 수리기사가 되려고 했습니다.<br>
                       그러던 어느날 IT 분야에는 다양한 직업이 있다는 것을 알게 되었고,<br>
                       <b>'개발자'</b>라는 직업에 흥미가 생겨서 2016년부터 웹개발자가 되기 위한 준비를 했습니다.<br>
                    <p>제 목표는 어디서든 필요로하는 개발자가 되는 것이며,<br>
                       웹서비스를 제공하기 위한 모든 것을 아는 <b>'풀스택 개발자'</b>로 성장할 것입니다.
                    </p>
                </section>
            </div>
            ...
            <div class="desc">
                ...
                <div class="panel hide">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="item" style='background-image: url("./image/icon-react.png")'>
                            <div class="label">
                                <p>React</p>
                                <p>하</p>
                            </div>
        ...
        <div class="Contact" id="Contact">
            ...
            <div class="desc hide">
                <p>E-mail</p><span id="clipboard-email" contenteditable="false">sehoane@gmail.com</span>
                <input id="clipboard" type="button" title="클립보드에 복사"/>
                <p>Github</p><span>powercode14</span>
                <input id="github" type="button" title="Github로 이동" onclick="window.open('https://github.com/powercode14?utf8=%E2%9C%93&tab=repositories&q=&type=public&language=')"/>
                <p>Blog</p><a href="https://powercode.tistory.com" target="_blank">https://powercode.tistory.com</a>
                <input id="blog" type="button" title="Tistory 블로그로 이동" onclick="window.open('https://powercode.tistory.com/')"/>
            </div>
            <div class="end hide">
                <p>Thank you</p>
            </div>
